...
class SignalingGame:
  """A signaling game between two agents, alternatively acting as the sender and the receiver

  Simulates the result of a repeated signaling game between two agents, given the number of (world) states, the number of signals for the sender, and the number of actions for the receiver.
  ...
  Attributes:
    ...
    receiver (Agent): the initial receiver
    sender (Agent): the initial sender
  ...
  def __init__(self, num_states: int, num_signals: int, num_actions: int, 
    ...
    self.sender = Agent(self.num_states, self.num_signals, self.num_actions, self, null_signal)
    self.receiver = Agent(self.num_states, self.num_signals, self.num_actions, self, null_signal)
