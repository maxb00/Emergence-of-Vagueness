...
def main(info=None):
  if info == None:
    ...
    (nstates, nsignals, nactions, rp1, rp2, null, niter, record, repeat_num, gif_choice, distrobution) = info

  game = SignalingGame(nstates, nsignals, nactions, 
                       (rp1, rp2), null_signal=null, dist=distrobution)
  game(niter, record, repeat_num=repeat_num, make_gif=gif_choice)
